//
// go build -v -ldflags="-extldflags=-static" -o vm vm.go
//
...
func main() {
	...
	fmt.Println("##########################################")
	fmt.Println("# Welcooome to VM-O-MATIC                #")
	fmt.Println("#                                        #")
	...
	if scanner.Scan() {
		...
		// Algo: XOR with theblackpirate and two ROL
		secret := []byte{0x25, 0x55, 0x3d, 0xf4, 0x31, 0x88, 0x30, 0x14, 0x5c, 0x6c, 0x4c, 0x54, 0x38, 0x11, 0x51, 0xec, 0x59, 0x45, 0x31, 0x60, 0x4d, 0x78, 0x41, 0x20, 0x18, 0x05, 0xf0, 0x45, 0x5c, 0x0c, 0x59, 0x40, 0x7c, 0x18, 0x18, 0x14, 0x45, 0x25, 0xb4, 0x2d, 0x25, 0x61}
